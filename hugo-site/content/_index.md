...
- **[Traces of Memorisation in Large Language Models for Code]({{< relref "/publications/traces-memorisation" >}})** (ICSE'24)  
  *Exploring memorisation in code language models and data extraction vulnerabilities*
...
- **Dutch National Symposium on Software Engineering (SEN) Talk** (2023)
  *Lightning Talk Titled: Co-Pilot the Open Source Laundromat*
- **ICSE'23 Student Volunteer**

### Awards 🥇
- **ACM SIGSOFT Distinguished Paper Award**  
  *For the paper: How Much Do Code Language Models Remember? An Investigation on Data Extraction Attacks before and after Fine-tuning at MSR'25*
  [📄 Paper](https://ieeexplore.ieee.org/abstract/document/11025762)

- **Training Data Extraction Challenge - First Place**  
  *SATML'23 Training Data Extraction Challenge*  
  [📄 Competition Report](https://arxiv.org/abs/2302.07735)

- **Code Comment Classification - First Place**  
